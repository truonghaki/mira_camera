...
const blankInput: RentalFormInput = { camera_id: "", customer_name: "", customer_phone: "", customer_address: "", start_time: "", end_time: "", rental_price: "0", deposit_info: "", status: "BOOKED", note: "" };
